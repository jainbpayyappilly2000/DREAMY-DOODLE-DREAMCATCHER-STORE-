<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SELLER_REG.aspx.cs" Inherits="dreamydoodleProject.SELLER_REG" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">MOBILE-1</td>
                    <td>
                        <asp:TextBox ID="TextBoxMOB1" runat="server" TextMode="Phone"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style2">MOBILE-2</td>
                    <td>
                        <asp:TextBox ID="TextBoxMOB2" runat="server" TextMode="Phone"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownListDIST" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
