<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userLogin.aspx.cs" Inherits="dreamydoodleProject.userLogin" %>
                ...
                <div class="login-form">
                    <div class="sign-in-htm">
                        ...
                        <div class="group">
                            ...
                            <asp:Button ID="Button1" class="button" runat="server" Text="REGISTER" OnClick="Button2_Click" />
                    ...
                    <div class="sign-up-htm">
                        <div class="group">
                            <label for="fname" class="label">
                                ...
                                FIRST NAME</label>
                            <asp:TextBox ID="TextBoxfname" class="input" runat="server"></asp:TextBox>
                        ...
                        <div class="group">
                            <label for="lname" class="label">
                                <ion-icon name="person-circle"></ion-icon>
                                LAST NAME</label>
                            <asp:TextBox ID="TextBoxlname" class="input" runat="server"></asp:TextBox>
                        ...
                        <div class="group">
                            <label for="mobile" class="label">
                                ...
                                PHONE NUMBER</label>
                            <asp:TextBox ID="TextBoxphno" class="input" runat="server" TextMode="Phone"></asp:TextBox>
